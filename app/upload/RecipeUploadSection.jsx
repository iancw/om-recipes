...
// thumbnail, extracted (and rotated upright) during the EXIF parse in
// RecipeUpload and stapled onto the File as `previewDataUrl`. Reading it here
// is synchronous, so the previews never lag behind the pending-file list and no
// object URLs need to be created or revoked.
